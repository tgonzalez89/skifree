...
OEMLabel		db "SKIFREE "	; Disk label
...
VolumeLabel		db "SKIFREE    "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "SKIFREE BIN"	; MikeOS kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "SKIFREE.BIN not found!", 0
